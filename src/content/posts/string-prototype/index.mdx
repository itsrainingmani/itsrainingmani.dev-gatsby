...
<NormalImage src={federico} caption="by Federico Beccari" />

## What is an Object Prototype

From <XA href="https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/Object_prototypes">MDN</XA>
...
If you found this post to be helpful, or want to report any errors, hit me up on the <XA href="https://twitter.com/itsrainingmani">Blue Site</XA>.
</section>